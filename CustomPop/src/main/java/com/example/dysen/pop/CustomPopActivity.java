...
public class CustomPopActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void handleLogic(View contentView){
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (i == R.id.menu5) {
                    showContent = "点击 Item菜单5";

                }
                Toast.makeText(CustomPopActivity.this,showContent,Toast.LENGTH_SHORT).show();
            }
        };
